...
public class Graficos extends javax.swing.JInternalFrame {
    ...
    public Graficos(String tituloGrafico, String textoEixoX, String textoEixoY, DefaultCategoryDataset categoryDataSet) {
        this.tituloGrafico = "Emissão por entrega";
        this.textoEixoX = "eixo x";
        this.textoEixoY = "eixo y";
